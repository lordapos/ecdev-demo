    ...
    <Layout>
      ...
      <section className="terms">
        <div className="terms__inner">
          <div className="terms__information">
            <h1>Website Terms of Use</h1>
            <p>The ecdevstudio.com website located at ecdevstudio.com is a copyrighted work belonging to EcDevStudio.
              Certain features of the Site may be subject to additional guidelines, terms, or rules, which will be posted
              on the Site in connection with such features.</p>
            ...
            <p>These Terms of Use described the legally binding terms and conditions that oversee your use of the Site. BY
              ...
              IF YOU DISAGREE WITH ALL OF THE PROVISION OF THESE TERMS, DO NOT LOG INTO AND/OR USE THE SITE.</p><p>
          </p><p>These terms require the use of arbitration Section 10.2 on an individual basis to resolve disputes and
            also limit the remedies available to you in the event of a dispute.</p>
          </div>
          <div className="terms__information">
          ...
          <div className="terms__information">
            <h5>Third-Party Links &amp; Ads; Other Users</h5>
            <p><strong>Third-Party Links &amp; Ads. </strong>The Site may contain links to third-party websites and
              ...
              party’s terms and policies apply, including the third party’s privacy and data gathering practices.</p>
          ...
          <div className="terms__information">
            ...
            <p>These Terms are subject to occasional revision, and if we make any substantial changes, we may notify you
              ...
              procedures for MANDATORY BINDING ARBITRATION AND A CLASS ACTION WAIVER.</p>
            ...
            <p><strong>Notice Requirement and Informal Dispute Resolution. </strong>Before either party may seek
              ...
              Ukraine, Lviv. After the Notice is received, you and the Company may attempt to resolve the claim or dispute
              ...
              amount of the award to which either party is entitled.</p>
            ...
            <p>In any circumstances where the foregoing Arbitration Agreement permits the parties to litigate in court,
              ...
              County, California, for such purposes.</p>
