    ...
    <Layout>
      ...
      <section className="policy">
        <div className="policy__inner">
          <div className="policy__information">
            <h1>Privacy Policy</h1>
            <p className="policy__information__update"><span>Last updated: </span>January 26, 2021</p>
            <p>This Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your
              information when You use the Service and tells You about Your privacy rights and how the law protects to the
              collection and use of information in accordance with this Privacy Policy. </p>
          </div>
          <div className="policy__information">
            <h5>Interpretation and Definitions</h5>
            <p className="policy__information__tagline">Interpretation</p>
            <p>
          ...
          <div className="policy__information">
            ...
            <ul>
              ...
              <li>
                <p><strong>Website </strong>refers to EcDevStudio, accessible from <a href="https://www.ecdevstudio.com"
                                                                                      rel="external nofollow noopener"
                                                                                      target="_blank">ecdevstudio.com</a>
                </p>
              </li>
              <li>
          ...
          <div className="policy__information">
            ...
            <p className="policy__information__tagline">Types of Data Collected</p>
            <p className="policy__information__title">Personal Data</p>
            ...
            <p className="policy__information__title">Usage Data</p>
            ...
            <p className="policy__information__title">Tracking Technologies and Cookies</p>
            ...
            <p>Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal computer or
              ...
              You can learn more about cookies here: <a href="https://www.termsfeed.com/blog/cookies/" target="_blank">All
          ...
          <div className="policy__information">
            <p className="policy__information__tagline">Use of Your Personal Data</p>
            <p>The Company may use Personal Data for the following purposes:</p>
            <ul className="policy-personal-list">
              <li>
          ...
          <div className="policy__information">
            <p className="policy__information__tagline">
          ...
          <div className="policy__information">
            <div className="policy__information__tagline">
          ...
          <div className="policy__information">
            <p className="policy__information__tagline">Disclosure of Your Personal Data</p>
            <p className="policy__information__title">Business Transactions</p>
            <p>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred.
              ...
              Policy.</p>
            <p className="policy__information__title">Law enforcement</p>
            ...
            <p className="policy__information__title">Other legal requirements</p>
          ...
          <div className="policy__information">
            ...
            <p>By visiting this page on our website: <a href="https://www.ecdevstudio.com"
                                                        rel="external nofollow noopener"
                                                        target="_blank">ecdevstudio.com</a>
            </p>
          </div>
