const products = [
  {
    ...
    highlights: JSON.stringify(
      [
        ...
        'ISO Expandable to 3,280,000 100-102,400',
    ...
    specs: JSON.stringify(
      [
        ...
        {
          key: 'Sensor Size',
          value: '35.9 mm x 23.9 mm'
        },
        {
          key: 'Image Sensor Format',
          value: 'FX'
        },
        {
          key: 'Storage Media',
          value: 'CompactFlash© (CF) (Type I, compliant with UDMA) XQD Type Memory'
        },
        {
          key: 'Monitor Size',
          value: '3.2 in. diagonal'
        },
        {
          key: 'Monitor Type',
          value: 'TFT touch-sensitive LCD'
        },
        {
  ...
  },
  {
    ...
    specs: JSON.stringify(
      [
        ...
        {
          key: 'Storage Media',
          value: 'CFexpress (Type B) XQD Type Memory'
        },
        {
          key: 'Monitor Size',
          value: '3.2 in. diagonal'
  ...
  },
  {
    ...
    highlights: JSON.stringify(
      [
        ...
        'ISO Expandable to 102,400 64-25,600',
        '3840 x 2160 at 30/25/24p 4K UHD',
      ]),
    specs: JSON.stringify(
      [
        ...
        {
          key: 'Storage Media',
          value: '1 XQD card and 1 Secure Digital (SD) card SD SDHC (UHS-II compliant) SDXC (UHS-II compliant) XQD Type Memory'
        },
        {
          key: 'Monitor Size',
          value: '3.2 in. diagonal'
        ...
        {
          key: 'Monitor Type',
          value: 'Tilting TFT touch-sensitive LCD'
        },
        {
          key: 'Battery / Batteries',
  ...
  },
  {
    ...
    highlights: JSON.stringify(
      [
        ...
        'ISO Expandable to 204,800 100-51,200',
        'Movie Full HD 1,920x1,080 / 30 fps',
      ]),
    specs: JSON.stringify(
      [
        {
        ...
        {
          key: 'Monitor Type',
          value: 'Wide Viewing Angle TFT-LCD'
        },
        {
          key: 'Battery / Batteries',
  ...
  },
  {
    ...
    highlights: JSON.stringify(
      [
          ...
          'Megapixels 12',
          'Optical Zoom 4.6x',
          'Dimensions 1.85 x 4.7 x 3.2 inches',
  ...
  },
  {
    ...
    specs: JSON.stringify(
      [
        ...
        {
          key: 'Maximum aperture',
          value: 'f/3.5-4.5'
        },
        {
          key: 'Minimum aperture',
          value: 'f/22-29'
        },
        {
          key: 'Minimum focus distance',
          value: '0.16 m/0.5 ft from focal plane'
        },
        {
          key: 'Maximum reproduction ratio',
          value: '0.34x'
        },
      ]
    ),
  ...
  },
  {
    ...
    highlights: JSON.stringify(
      [
        ...
        'Three XA Elements',
        '2-pin Communication System',
        'Aperture Range: f/2.8 to f/22',
        'Compatible with FLEX1.4/FLEX2 Extenders for 840mm/1200mm',
      ]),
    specs: JSON.stringify(
      [
        {
          key: 'Lens Construction',
          value: '10 elements in 7 groups'
        },
        {
          key: 'Focus Adjustment',
          value: 'AF with full-time manual'
        },
        {
          key: 'Closest Focusing Distance',
          value: '14.76 ft / 4.5m'
        },
      ]
    ),
  },
  {
    ...
    highlights: JSON.stringify(
      [
        ...
        'The dimensions of the bag are: 9.84 (L) x 7.87 (W) x 5.1 (H) inches, 1.05 lbs',
      ]),
    specs: JSON.stringify(
      [
        {
  ...
  },
  {
    ...
    highlights: JSON.stringify(
      [
        ...
        'Tripod Pocket & Attachment Strap on Side',
        'Accommodates 15" Laptop or Tablet',
        'Two Adjustable Interior Dividers'
      ]),
    specs: JSON.stringify(
      [
        {
          key: 'Holds ',
          value: '1-2 Cameras, 3 Lenses, Accessories'
        },
        {
          key: 'Accommodates',
  ...
  },
  {
    ...
    highlights: JSON.stringify(
      [
        ...
        'Wide Flap Cover with Buckles',
        'Semi-Soft Construction',
        'Two Movable Interior Dividers'
      ]),
    specs: JSON.stringify(
      [
        {
